package com.example.mobitail.Retaier
...
class SignUpStep2 : AppCompatActivity() {
    ...
    private fun readCountryDataFromJson() {
        val json: String =
            applicationContext.assets.open("states.json").bufferedReader().use { it.readText() }
        ...
        try {
            ...
            for (i in 0 until jsonArray.length()) {
                ...
                if (countryName == "Jordan") {
                    ...
                    val spinnerAdapter =
                        ArrayAdapter(this, android.R.layout.simple_spinner_item, countyList)
