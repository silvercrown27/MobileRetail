...
class CategoryItemsAdapter : RecyclerView.Adapter<CategoryItemsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryItemsAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_list_viewer, parent, false)
